...
mixin _$ReviewEntity {
 ...
 String get reviewId; String get reviewerId; String get targetId; int get rating; String? get comment;@TimestampConverter() DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,reviewId,reviewerId,targetId,rating,comment,createdAt);
...
@useResult
$Res call({
 String reviewId, String reviewerId, String targetId, int rating, String? comment,@TimestampConverter() DateTime createdAt
});
...
/// Create a copy of ReviewEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? reviewId = null,Object? reviewerId = null,Object? targetId = null,Object? rating = null,Object? comment = freezed,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String reviewId,  String reviewerId,  String targetId,  int rating,  String? comment, @TimestampConverter()  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReviewEntity() when $default != null:
return $default(_that.reviewId,_that.reviewerId,_that.targetId,_that.rating,_that.comment,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String reviewId,  String reviewerId,  String targetId,  int rating,  String? comment, @TimestampConverter()  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _ReviewEntity():
return $default(_that.reviewId,_that.reviewerId,_that.targetId,_that.rating,_that.comment,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String reviewId,  String reviewerId,  String targetId,  int rating,  String? comment, @TimestampConverter()  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _ReviewEntity() when $default != null:
return $default(_that.reviewId,_that.reviewerId,_that.targetId,_that.rating,_that.comment,_that.createdAt);case _:
  return null;
...
class _ReviewEntity implements ReviewEntity {
  const _ReviewEntity({required this.reviewId, required this.reviewerId, required this.targetId, required this.rating, this.comment, @TimestampConverter() required this.createdAt});
...
/// Create a copy of ReviewEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? reviewId = null,Object? reviewerId = null,Object? targetId = null,Object? rating = null,Object? comment = freezed,Object? createdAt = null,}) {
