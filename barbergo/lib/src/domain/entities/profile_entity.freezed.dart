...
mixin _$ProfileEntity {
 ...
 String get userId; AccountType get accountType; String get name; String get email; String get bio; String get location; String get contactPhone; String? get fcmToken;@TimestampConverter() DateTime get createdAt;@TimestampConverter() DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,userId,accountType,name,email,bio,location,contactPhone,fcmToken,createdAt,updatedAt);

@override
String toString() {
  return 'ProfileEntity(userId: $userId, accountType: $accountType, name: $name, email: $email, bio: $bio, location: $location, contactPhone: $contactPhone, fcmToken: $fcmToken, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String userId, AccountType accountType, String name, String email, String bio, String location, String contactPhone, String? fcmToken,@TimestampConverter() DateTime createdAt,@TimestampConverter() DateTime? updatedAt
});
...
/// Create a copy of ProfileEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? accountType = null,Object? name = null,Object? email = null,Object? bio = null,Object? location = null,Object? contactPhone = null,Object? fcmToken = freezed,Object? createdAt = null,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String userId,  AccountType accountType,  String name,  String email,  String bio,  String location,  String contactPhone,  String? fcmToken, @TimestampConverter()  DateTime createdAt, @TimestampConverter()  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProfileEntity() when $default != null:
return $default(_that.userId,_that.accountType,_that.name,_that.email,_that.bio,_that.location,_that.contactPhone,_that.fcmToken,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String userId,  AccountType accountType,  String name,  String email,  String bio,  String location,  String contactPhone,  String? fcmToken, @TimestampConverter()  DateTime createdAt, @TimestampConverter()  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _ProfileEntity():
return $default(_that.userId,_that.accountType,_that.name,_that.email,_that.bio,_that.location,_that.contactPhone,_that.fcmToken,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String userId,  AccountType accountType,  String name,  String email,  String bio,  String location,  String contactPhone,  String? fcmToken, @TimestampConverter()  DateTime createdAt, @TimestampConverter()  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _ProfileEntity() when $default != null:
return $default(_that.userId,_that.accountType,_that.name,_that.email,_that.bio,_that.location,_that.contactPhone,_that.fcmToken,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _ProfileEntity implements ProfileEntity {
  const _ProfileEntity({required this.userId, required this.accountType, required this.name, required this.email, this.bio = '', this.location = '', this.contactPhone = '', this.fcmToken, @TimestampConverter() required this.createdAt, @TimestampConverter() this.updatedAt});
...
/// Create a copy of ProfileEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? accountType = null,Object? name = null,Object? email = null,Object? bio = null,Object? location = null,Object? contactPhone = null,Object? fcmToken = freezed,Object? createdAt = null,Object? updatedAt = freezed,}) {
