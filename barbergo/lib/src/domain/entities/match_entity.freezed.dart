...
mixin _$MatchEntity {
 ...
 String get matchId; List<String> get participants;@TimestampConverter() DateTime get matchedAt; Map<String, dynamic>? get contactInfo;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MatchEntity&&(identical(other.matchId, matchId) || other.matchId == matchId)&&const DeepCollectionEquality().equals(other.participants, participants)&&(identical(other.matchedAt, matchedAt) || other.matchedAt == matchedAt)&&const DeepCollectionEquality().equals(other.contactInfo, contactInfo));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,matchId,const DeepCollectionEquality().hash(participants),matchedAt,const DeepCollectionEquality().hash(contactInfo));
...
@useResult
$Res call({
 String matchId, List<String> participants,@TimestampConverter() DateTime matchedAt, Map<String, dynamic>? contactInfo
});
...
/// Create a copy of MatchEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? matchId = null,Object? participants = null,Object? matchedAt = null,Object? contactInfo = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String matchId,  List<String> participants, @TimestampConverter()  DateTime matchedAt,  Map<String, dynamic>? contactInfo)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MatchEntity() when $default != null:
return $default(_that.matchId,_that.participants,_that.matchedAt,_that.contactInfo);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String matchId,  List<String> participants, @TimestampConverter()  DateTime matchedAt,  Map<String, dynamic>? contactInfo)  $default,) {final _that = this;
switch (_that) {
case _MatchEntity():
return $default(_that.matchId,_that.participants,_that.matchedAt,_that.contactInfo);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String matchId,  List<String> participants, @TimestampConverter()  DateTime matchedAt,  Map<String, dynamic>? contactInfo)?  $default,) {final _that = this;
switch (_that) {
case _MatchEntity() when $default != null:
return $default(_that.matchId,_that.participants,_that.matchedAt,_that.contactInfo);case _:
  return null;
...
class _MatchEntity implements MatchEntity {
  const _MatchEntity({required this.matchId, required final  List<String> participants, @TimestampConverter() required this.matchedAt, final  Map<String, dynamic>? contactInfo}): _participants = participants,_contactInfo = contactInfo;
...
@override@TimestampConverter() final  DateTime matchedAt;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MatchEntity&&(identical(other.matchId, matchId) || other.matchId == matchId)&&const DeepCollectionEquality().equals(other._participants, _participants)&&(identical(other.matchedAt, matchedAt) || other.matchedAt == matchedAt)&&const DeepCollectionEquality().equals(other._contactInfo, _contactInfo));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,matchId,const DeepCollectionEquality().hash(_participants),matchedAt,const DeepCollectionEquality().hash(_contactInfo));
...
/// Create a copy of MatchEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? matchId = null,Object? participants = null,Object? matchedAt = null,Object? contactInfo = freezed,}) {
...
as List<String>,matchedAt: null == matchedAt ? _self.matchedAt : matchedAt // ignore: cast_nullable_to_non_nullable
as DateTime,contactInfo: freezed == contactInfo ? _self._contactInfo : contactInfo // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,
  ));
}
